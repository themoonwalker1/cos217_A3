...
const void *pvValue)
{
    ...
    size_t bucket = SymTable_hash(pcKey, oSymTable->buckets);
    ...
    psNewNode->psNextNode = *(oSymTable->ppsFirstNode + bucket);
...
const void *pvValue)
{
    ...
    size_t bucket = SymTable_hash(pcKey, oSymTable->buckets);
    psTempNode = *(oSymTable->ppsFirstNode + bucket);
...
const void *pvExtra)
{
    ...
    for (int i = 0; i < oSymTable->buckets; i++)
    {
